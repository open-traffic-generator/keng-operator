...
def test_b2b_default_config():
    """
    Deploy b2b kne topology with default version, with last supported grpc controller version,
    - namespace - 1: ixia-c
    ...
    ctrl_version_old_grpc = "0.0.1-3113"
    try:
        op_rscount = utils.get_operator_restart_count()
        utils.load_grpc_configmap(True, ctrl_version_old_grpc)
